...
<html lang="en">
   <head>
      ...
      <title>Doccure</title>
      <link type="image/x-icon" href="/front/img/favicon.png" rel="icon">
   ...
   <body>
         ...
         <header class="header">
            <nav class="navbar navbar-expand-lg header-nav">
               <div class="navbar-header">
                  ...
                  <img src="/front/img/logo.png" class="img-fluid" alt="Logo">
                  </a>
               </div>
               ...
               <ul class="nav header-navbar-rht">
                  ...
                  <li class="nav-item">
                     <a class="nav-link header-login btn-one-light" href="login.html">login / Signup </a>
                  </li>
               </ul>
            </nav>
         </header>
                           ...
                           <div class="card text-center doctor-book-card">
                              ...
                              <div class="doctor-book-card-content tile-card-content-1">
                                 <div>
                                    ...
                                    <a href="search.html" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Book Now</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="card text-center doctor-book-card">
                              ...
                              <div class="doctor-book-card-content tile-card-content-1">
                                 <div>
                                    ...
                                    <a href="pharmacy-search.html" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Find Now</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="card text-center doctor-book-card">
                              ...
                              <div class="doctor-book-card-content tile-card-content-1">
                                 <div>
                                    ...
                                    <a href="javascript:void(0);" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Coming Soon</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <ul class="entry-meta meta-item">
                              <li>
                                 <div class="post-author">
                                    <a href="doctor-profile.html"><img src="/front/img/doctors/doctor-thumb-01.jpg" alt="Post Author"> <span>Dr. Ruby Perrin</span></a>
                                 </div>
                              </li>
                     ...
                     <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                           <ul class="entry-meta meta-item">
                              <li>
                                 <div class="post-author">
                                    <a href="doctor-profile.html"><img src="/front/img/doctors/doctor-thumb-02.jpg" alt="Post Author"> <span>Dr. Darren Elder</span></a>
                                 </div>
                              </li>
                     ...
                     <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                           <ul class="entry-meta meta-item">
                              <li>
                                 <div class="post-author">
                                    <a href="doctor-profile.html"><img src="/front/img/doctors/doctor-thumb-03.jpg" alt="Post Author"> <span>Dr. Deborah Angel</span></a>
                                 </div>
                              </li>
                              <li><i class="far fa-clock"></i> 3 Dec 2019</li>
                           </ul>
                     ...
                     <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                           <ul class="entry-meta meta-item">
                              <li>
                                 <div class="post-author">
                                    <a href="doctor-profile.html"><img src="/front/img/doctors/doctor-thumb-04.jpg" alt="Post Author"> <span>Dr. Sofia Brient</span></a>
                                 </div>
                              </li>
                     ...
                     <div class="col-lg-3 col-md-6">
                        <div class="footer-widget footer-about">
                           <div class="footer-logo">
                              <img src="/front/img/footer-logo.png" alt="logo">
                           </div>
                        ...
                        <div class="footer-widget footer-contact">
                           ...
                           <div class="footer-contact-info">
                              ...
                              <p class="mb-0">
                                 ...
                                 <a href="https://doccure.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3b5f5458584e495e7b5e435a564b575e15585456">[email&#160;protected]</a>
                              </p>
                           </div>
                        </div>
                     </div>
      ...
      <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="/front/js/jquery-3.6.0.min.js"></script>
