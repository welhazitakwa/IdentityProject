                                ...
                                <div class="card m-b-30">
                                    ...
                                    <div class="card-body">
                                        <div class="profilebox py-4 text-center">
                                            <img src="/back/images/users/profile.svg" class="img-fluid" alt="profile">
                                            <div class="profilename">
                                                <h5>Shourya Kumar</h5>
                                                <p class="text-muted"><a href="my-account.html"><i class="feather icon-edit-2 mr-2"></i>Edit Profile</a></p>
                                            </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-borderless">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">1</th>
                                                                    <td><img src="/back/images/ecommerce/product_01.svg" class="img-fluid" width="35" alt="product"></td>
                                                                    <td>Apple Watch</td>
                                                                    <td>1</td>
                                                                    <td>$100</td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">2</th>
                                                                    <td><img src="/back/images/ecommerce/product_02.svg" class="img-fluid" width="35" alt="product"></td>
                                                                    <td>Apple iPhone</td>
                                                                    <td>2</td>
                                                                    <td>$200</td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th scope="row">3</th>
                                                            <td><img src="/back/images/ecommerce/product_03.svg" class="img-fluid" width="35" alt="product"></td>
                                                            <td>Apple iPad</td>
                                                            <td>
                                                                <div class="form-group mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-center">
                                            <div class="col-sm-6 col-md-6 col-lg-4">
                                                <img src="/back/images/ecommerce/wallet.svg" class="img-fluid" alt="wallet">
                                            </div>
                                        </div>
                                        <div class="wallet-box">
                                            <div class="row align-items-center">
                                                <div class="col-sm-6">
                                                    <h4 class="text-primary"><i class="feather icon-credit-card mr-2"></i>$45 <span class="font-14">Balance</span></h4>
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-6 col-xl-4">
                                                <div class="logout-content text-center my-5">
                                                    <img src="/back/images/ecommerce/logout.svg" class="img-fluid mb-5" alt="logout">
